...
// This page is intentionally a client component so we can use IntersectionObserver
// for the in-page navigation (scroll-spy). Data is mocked here; replace with
// a real fetch by id (Supabase/API) when ready.
