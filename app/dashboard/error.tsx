...
import { AlertTriangle, RefreshCw, BarChart3, Home } from 'lucide-react'
...
export default function DashboardError({ error, reset }: DashboardErrorProps) {
  useEffect(() => {
    ...
    // Track dashboard errors for user experience monitoring
  }, [error])
        ...
        <div className="text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              We're having trouble loading your dashboard. Your data is safe.
            </p>
          </div>
